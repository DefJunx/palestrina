...
{#if editor}
	<div class="flex gap-x-2 items-center">
		...
		<button
			class="btn btn-sm {editor.isActive('heading', { level: 2 })
				? 'variant-filled-primary'
				: 'variant-ghost'}"
			type="button"
		...
		<button
			class="btn btn-sm {editor.isActive('bulletList')
				? 'variant-filled-primary'
				: 'variant-ghost'}"
			type="button"
		...
		<button
			class="btn btn-sm {editor.isActive('orderedList')
				? 'variant-filled-primary'
				: 'variant-ghost'}"
			type="button"
		...
		<button
			class="btn btn-sm {editor.isActive('horizontalRule')
				? 'variant-filled-primary'
				: 'variant-ghost'}"
			type="button"
