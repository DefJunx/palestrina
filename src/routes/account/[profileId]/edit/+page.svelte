...
<form method="post" class="mt-8 flex w-full flex-col space-y-8" use:enhance enctype="multipart/form-data">
  <div class="flex flex-col">
    ...
    <input disabled={loading} class="input mt-1" type="text" name="username" bind:value={$form.username} />
    {#if $errors.username}
  ...
  <div class="flex flex-col">
    ...
    <input class="input mt-1" disabled={loading} type="text" name="fullName" bind:value={$form.fullName} />
    {#if $errors.fullName}
